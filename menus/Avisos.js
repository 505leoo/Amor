...
const SECCIONES = [
  ...
  { id: 'novedades', titulo: 'Novedades', descripcion: 'Noticias y cambios importantes de Amor.', icono: 'new-releases', tarjetas: [
    ...
    { id: 'actualizacion-1-0-2-a-1-0-4', titulo: 'Actualización General', texto: 'Arreglamos varias cosas para que Amor funcione mejor.', fecha: '2026-08-21', detalle: 'En esta actualización arreglamos varios problemas: el Comerciante entrega sus objetos correctamente; mejorar a Halcón funciona con las monedas y cartas correctas; los juegos entregan recompensas más equilibradas; el nivel y la barra de EXP del perfil se muestran correctamente; las actualizaciones de la app llegan a producción; el menú de pareja carga mejor, muestra quién está conectado de verdad y no enseña personas que ya tienen pareja; también mejoramos las temporadas, los avisos y varias pantallas para que todo sea más claro y estable. La versión cambió de la 1.0.2 a la 1.0.4.' },
