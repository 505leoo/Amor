...
export const RECURSOS_APP = [
  require('./assets/16.png'), require('./assets/adaptive-icon.png'),
  require('./assets/favicon.png'), require('./assets/icon.png'), require('./assets/notifications.png'),
  require('./assets/splash-icon.png'), require('./assets/splash.png'),
  require('./assets/inicio/inicio.png'), require('./assets/inicio/iniciot2.png'), require('./assets/inicio/jugar.png'),
  require('./assets/inicio/menta1.png'), require('./assets/inicio/pareja.png'), require('./assets/inicio/regalodiario.png'),
  require('./assets/inicio/halcon-icono.png'), require('./assets/inicio/anuncios/anunciocumple.png'), require('./assets/inicio/anuncios/anuncioreporte.png'),
  require('./assets/inicio/comercio.png'), require('./assets/inicio/eventos/eventochicle.png'), require('./assets/inicio/eventos/eventoglobo.png'),
  require('./assets/inicio/eventos/eventokitty.png'), require('./assets/inicio/eventos/eventorutas.png'),
  require('./assets/inicio/iconos/icono1.jpg'), require('./assets/inicio/iconos/icono-ajolote-caramelo.png'),
  require('./assets/inicio/iconos/icono-ardilla-bellota-v2.png'), require('./assets/inicio/iconos/icono-erizo-dulce-medianoche.png'),
  require('./assets/inicio/iconos/icono-gato-ovillo-dorado.png'), require('./assets/inicio/iconos/icono-mono-selva-dorada.png'),
  require('./assets/inicio/iconos/icono-pezglobo-perla-abisal.png'),
  require('./assets/menu/img1.jpg'), require('./assets/juegos/conexion.png'), require('./assets/juegos/juegos_overlay.png'),
  require('./assets/temporadas/neutral.png'), require('./assets/temporadas/reward.png'), require('./assets/temporadas/rewardopen.png'),
  require('./assets/temporadas/libro/coleccion1.png'), require('./assets/temporadas/libro/libro1.png'), require('./assets/temporadas/libro/libro2.png'),
  require('./assets/temporadas/libro/libro3.png'), require('./assets/temporadas/libro/libroanimal.png'), require('./assets/temporadas/libro/libroanimal2.png'),
  require('./assets/temporadas/libro/panel1.png'), require('./assets/temporadas/libro/panel2.png'),
  require('./assets/temporadas/libro/Temporada1/evento1.png'), require('./assets/temporadas/libro/Temporada1/fondo1.png'),
  require('./assets/temporadas/libro/Temporada1/Historia/eventohis1.png'), require('./assets/temporadas/libro/Temporada1/Historia/historia1.png'),
  require('./assets/temporadas/libro/Temporada1/Historia/historia2.png'), require('./assets/temporadas/libro/Temporada1/Historia/historia3.png'),
  require('./assets/temporadas/libro/Temporada1/Historia/historia4.png'), require('./assets/temporadas/libro/Temporada1/Historia/historia5.png'),
  require('./assets/temporadas/libro/Temporada1/Historia/historia6.png'), require('./assets/temporadas/libro/Temporada1/logo1.png'),
  require('./assets/temporadas/libro/Temporada2/fondo2.png'), require('./assets/temporadas/libro/Temporada2/kitty2.png'),
  require('./assets/temporadas/libro/Temporada2/logo1.png'), require('./assets/temporadas/libro/Temporada2/logokitty.png'),
  ...
  require('./assets/Animalitos/Abeja/abeja1.png'), require('./assets/Animalitos/Ajolote/ajolote1.png'),
  require('./assets/Animalitos/Ajolote/skins/ajolotet1.png'), require('./assets/Animalitos/Ajolote/skins/ajolotet2.png'),
  require('./assets/Animalitos/Ardilla/ardilla1.png'), require('./assets/Animalitos/Ardilla/skins/ardillat1.png'), require('./assets/Animalitos/Ardilla/skins/ardillat2.png'),
  require('./assets/Animalitos/Ballena/ballena1.png'), require('./assets/Animalitos/Buho/buho1.png'), require('./assets/Animalitos/CaballitoMar/caballitodemar1.png'),
  require('./assets/Animalitos/Cangrejo/cangrejo1.png'), require('./assets/Animalitos/Colibri/colibri1.png'), require('./assets/Animalitos/Conejo/conejo1.png'),
  require('./assets/Animalitos/Delfin/delfin1.png'), require('./assets/Animalitos/Erizo/erizo1.png'), require('./assets/Animalitos/Erizo/skins/erizot1.png'), require('./assets/Animalitos/Erizo/skins/erizot2.png'),
  require('./assets/Animalitos/Gato/gato1.png'), require('./assets/Animalitos/Gato/skins/gatot1.png'), require('./assets/Animalitos/Gato/skins/gatot2.png'),
  require('./assets/Animalitos/Halcon/halcon1.png'), require('./assets/Animalitos/Halcon/skins/halcont1.png'), require('./assets/Animalitos/Halcon/skins/halcont2.png'),
  require('./assets/Animalitos/Loro/loro1.png'), require('./assets/Animalitos/Loro/skins/lorot1.png'), require('./assets/Animalitos/Loro/skins/lorot2.png'),
  require('./assets/Animalitos/Mapache/mapache1.png'), require('./assets/Animalitos/Mariposa/mariposa1.png'), require('./assets/Animalitos/Mono/mono1.png'),
  require('./assets/Animalitos/Mono/skins/monot1.png'), require('./assets/Animalitos/Mono/skins/monot2.png'), require('./assets/Animalitos/Murcielago/murcielago1.png'),
  require('./assets/Animalitos/Oso/oso1.png'), require('./assets/Animalitos/Panda/panda1.png'), require('./assets/Animalitos/PezGlobo/pezglobo1.png'),
  require('./assets/Animalitos/PezGlobo/skins/pezglobot1.png'), require('./assets/Animalitos/PezGlobo/skins/pezglobot2.png'), require('./assets/Animalitos/Pulpo/pulpo1.png'),
  require('./assets/Animalitos/Tortuga/tortuga1.png'), require('./assets/Animalitos/Zorro/zorro1.png'),
];
