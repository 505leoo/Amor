...
export default function SystemUpdateGate({ version, visible = true }) {
  ...
  const required = policy?.obligatoria === true && isOlder(version, policy.versionMinimaBuild || policy.version);
